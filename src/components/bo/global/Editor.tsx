...
const Editor: React.FC = () => {
  ...
  const imageHandler = () => {
    ...
    input.onchange = async () => {
      ...
      const res = await axios.post("https://api.mealkeat.com/api/v1/upload", formData, {
        headers: {
      ...
      if (quillRef.current) {
        ...
        quillEditor.clipboard.dangerouslyPasteHTML(index, `<img src=${res.data.data} alt=${"alt text"} />`);
      }
    };
  };
